...
class UOS_Data:
    intro = (Data(["The ROBCO Model E-330 is the most reliable client terminal ever developed.",
    ...
    loading = (Data(["Initializing RobCo Industries(TM) MF Boot Agent v2.3.0",
                     "RETROS BIOS",
               ...
               Data([["Initializing  ", ". . . . ."]], (-1, 100), ["hard drive", "typing multiple"]),
